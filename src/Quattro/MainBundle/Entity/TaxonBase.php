...
class TaxonBase implements TaxonInterface
{

    /**
     * this class is only to avoid to load doctrine mapping from Sylius Taxon supermapped-class,
     * we have to set the order by in Children relation because supermappedclass doesn't have it
     * and <association-override> doesn't allow change it
     */
